...
void AddTaskFlowCentralityPID(Float_t centrMin=0.,
                              ...
                              AliPID::EParticleType particleType=AliPID::kDeuteron,
                              ...
                              TString uniqueStr="" )
{
  gSystem->CompileMacro("AliCustomPIDResponse.cxx","kg");
  ...
  AliCustomPIDResponse myPID(cutsPOI->GetESDpid());
  cutsPOI->GetESDpid() = (AliPIDResponse)myPID;
