...
//  RunGridFlowd.C
//
//  Created by Maximiliano Puccio on 18/11/14.
//  Copyright (c) 2014 ALICE. All rights reserved.
//

// CENTRALITY DEFINITION
Bool_t kUseCentrality = kFALSE;
Int_t binfirst = 0; //if kUseCentrality then change accordingly
Int_t binlast = 5;  //if kUseCentrality then change accordingly
                                    ...
                                    const char *proofcluster, const char *proofdataset)
{
  ...
  plugin->SetGridWorkingDir("deuteronFlow");
