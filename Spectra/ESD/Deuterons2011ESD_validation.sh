...
if ! [ -f mpuccio_Flowd.root ] ; then
   error=1
   echo "Output file mpuccio_Flowd.root not found. Job FAILED !" >> stdout
   echo "Output file mpuccio_Flowd.root not found. Job FAILED !" >> stderr
fi
if ! [ -f mpuccio_FlowdTree.root ] ; then
   error=1
   echo "Output file mpuccio_FlowdTree.root not found. Job FAILED !" >> stdout
   echo "Output file mpuccio_FlowdTree.root not found. Job FAILED !" >> stderr
fi
